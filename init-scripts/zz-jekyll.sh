...
DATABASE_DIR="${DATABASE_DIR_JEKYLL:-/data/db/sqlite}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set webroot
WWW_ROOT_DIR="/usr/share/webapps/jekyll"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Default predefined variables
DATA_DIR="/data/jekyll"   # set data directory
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TMP_DIR="/tmp/jekyll"
RUN_DIR="/run/jekyll"       # set scripts pid dir
...
SERVICE_USER="jekyll"  # execute command as another user
SERVICE_GROUP="jekyll" # Set the service group
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
EXEC_CMD_BIN='run_jekyll' # command to execute
EXEC_CMD_ARGS='serv'      # command arguments
...
[ -f "$CONF_DIR/env/jekyll.sh" ] && . "$CONF_DIR/env/jekyll.sh"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# root/admin user info [password/random]
#ENV_ROOT_USER_NAME="${ENV_ROOT_USER_NAME:-$JEKYLL_ROOT_USER_NAME}"   # root user name
#ENV_ROOT_USER_PASS="${ENV_ROOT_USER_NAME:-$JEKYLL_ROOT_PASS_WORD}"   # root user password
#root_user_name="${ENV_ROOT_USER_NAME:-$root_user_name}"                              #
#root_user_pass="${ENV_ROOT_USER_PASS:-$root_user_pass}"                              #
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#Normal user info [password/random]
#ENV_USER_NAME="${ENV_USER_NAME:-$JEKYLL_USER_NAME}"                  #
#ENV_USER_PASS="${ENV_USER_PASS:-$JEKYLL_USER_PASS_WORD}"             #
